...
export function AdminInfrastructurePanel({ overview }: { overview: AdminOverview }) {
  const dbGb = Number(overview?.database_size_bytes || 0) / 1024 / 1024 / 1024;
  return (
    <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
      <KpiCard label="Utilisateurs actifs" value={formatNumber(overview?.active_users)} hint="30 derniers jours" icon={Users} tone="blue" />
