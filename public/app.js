...
const i18n = {
  fr: {
    ...
    "acc.login.title":"Accéder à MegaCompagnon","acc.login.sub":"Votre session reste active : depuis MegaCompagnon, vous pouvez revenir ici puis rouvrir le dashboard sans vous reconnecter.","acc.email":"Adresse email","acc.password":"Mot de passe","acc.login.btn":"Se connecter","acc.devices":"Appareils jumelés","acc.loading":"Chargement...","acc.logout":"Se déconnecter","acc.profiles.title":"App web Companion","acc.profiles.sub":"Retrouvez vos statistiques, profils, appareils liés, progression et vues admin selon vos droits MegaTv Cloud.","acc.profiles.empty":"Connectez-vous pour voir vos profils","acc.companion.cta":"Accès MegaCompagnon","acc.signup.cta":"Créer un compte MegaCloud","acc.login.note":"Si vous êtes déjà connecté, l'accès ouvre directement Companion. Sinon, vous serez redirigé vers la connexion ID MegaTv.","acc.card.stats":"Dashboard personnel","acc.card.stats.sub":"Stats, continuité de lecture et contenus favoris","acc.card.cloud":"MegaTv Cloud","acc.card.cloud.sub":"Session sécurisée et données isolées par RLS",
  ...
  en: {
    ...
    "acc.login.title":"Open MegaCompanion","acc.login.sub":"Your session stays active: from MegaCompanion you can come back here and reopen the dashboard without signing in again.","acc.email":"Email address","acc.password":"Password","acc.login.btn":"Log in","acc.devices":"Paired devices","acc.loading":"Loading...","acc.logout":"Log out","acc.profiles.title":"Companion web app","acc.profiles.sub":"Find your stats, profiles, linked devices, progress and admin views according to your MegaTv Cloud permissions.","acc.profiles.empty":"Log in to see your profiles","acc.companion.cta":"Access MegaCompanion","acc.signup.cta":"Create a MegaCloud account","acc.login.note":"If you are already signed in, access opens Companion directly. Otherwise, you will be redirected to MegaTv ID login.","acc.card.stats":"Personal dashboard","acc.card.stats.sub":"Stats, continue watching and favorite content","acc.card.cloud":"MegaTv Cloud","acc.card.cloud.sub":"Secure session and RLS-isolated data",
