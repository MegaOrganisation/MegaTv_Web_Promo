-- MegaCompagnon : patch batch chaînes IPTV masquées (profil-scopé)
-- Miroir de megacompanion_patch_iptv_hidden_categories → iptvByProfile[profileId].hiddenChannels
...
begin
  ...
  -- Anti-wipe soft : liste vide = tout réafficher (préférence UX).
